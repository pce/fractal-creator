...
AbstractImage::AbstractImage(int width, int height) : _width(width), _height(height) {}

void AbstractImage::set_width(int width) {
    _width = width;
} 

void AbstractImage::set_height(int height) {
    _height = height;
}

int AbstractImage::get_width() {
    return _width;
} 

int AbstractImage::get_height() {
    return _height;
}

void AbstractImage::set_zoom(int zoom) {
    _zoom = zoom;
}

int AbstractImage::get_zoom() {
    return _zoom;
} 
